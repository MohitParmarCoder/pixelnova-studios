# Plank Bridge — Future Enhancements

## Priority Enhancements

### 1. Moving platforms (require precise timing)
### 2. Plank types: rope bridge (longer but sways), steel (shorter but stable)
### 3. Wind affecting plank rotation speed
### 4. Double-plank mode: extend two planks simultaneously
### 5. Precision bonus: within 5px of perfect = golden plank
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Plank Bridge! Can you beat me?").
