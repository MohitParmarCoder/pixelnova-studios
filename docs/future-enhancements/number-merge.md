# Number Merge — Future Enhancements

## Priority Enhancements

### 1. Power tiles: freeze (stops head value for 3 eats), reset (back to 2)
### 2. Visual number history trail (show last 5 values)
### 3. Challenge mode: reach 1024 in fewest moves
### 4. Wall tiles act as obstacles
### 5. Multiplayer: race to highest value
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Number Merge! Can you beat me?").
