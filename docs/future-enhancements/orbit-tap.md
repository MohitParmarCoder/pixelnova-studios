# Orbit Tap — Future Enhancements

## Priority Enhancements

### 1. Planet types: asteroid (fast orbit), moon (slow, high value), comet (linear path)
### 2. Chain destroy: tap 3 planets in 1 second for bonus
### 3. Solar flare event: all planets speed up for 5s
### 4. Galaxy map showing total planets destroyed
### 5. Boss planet: requires 3 taps to destroy
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Orbit Tap! Can you beat me?").
