# Neon Path — Future Enhancements

## Priority Enhancements

### 1. Third rail in center for trick maneuver (bonus score)
### 2. Power-up: slow rails for 3s
### 3. Inverse mode: gaps become path, path becomes gap
### 4. Night mode: rail lit only at gap edges
### 5. Dual-ball mode: control both balls simultaneously
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Neon Path! Can you beat me?").
