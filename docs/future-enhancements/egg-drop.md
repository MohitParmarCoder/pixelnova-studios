# Egg Drop — Future Enhancements

## Priority Enhancements

### 1. More recipe variety (12+ recipes)
### 2. Special ingredients: truffle (rare, high value), rotten (avoid)
### 3. Combo multiplier for recipe completion streaks
### 4. Night mode: kitchen lit only by stove glow
### 5. Boss round: extra items needed for complex 5-ingredient recipe
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Egg Drop! Can you beat me?").
