# Basket Shot — Future Enhancements

## Priority Enhancements

### 1. Wind direction indicator affecting ball arc
### 2. Alternate shot types: bounce pass, bank shot
### 3. Moving basket for dynamic difficulty
### 4. Streak bonus multiplier for consecutive makes
### 5. 3-pointer zone (far distance) for high-value shots
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Basket Shot! Can you beat me?").
