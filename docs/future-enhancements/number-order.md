# Number Order — Future Enhancements

## Priority Enhancements

### 1. Negative numbers variant
### 2. Countdown variant: tap in descending order
### 3. Number range expansion per level (1–10, 1–15, 1–20)
### 4. Missing number: one slot empty — find correct position
### 5. Speed bonus: faster taps score more
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Number Order! Can you beat me?").
