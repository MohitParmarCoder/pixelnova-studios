# Gravity Flip — Future Enhancements

## Priority Enhancements

### 1. Obstacles on ceiling too (not just walls)
### 2. Gravity ramps: flip happens automatically in a zone
### 3. Power-up: no-gravity bubble (briefly float)
### 4. Speedrun leaderboard
### 5. Visual wall textures (stone, metal, ice) that imply sliding behavior
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Gravity Flip! Can you beat me?").
