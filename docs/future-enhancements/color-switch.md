# Color Switch — Future Enhancements

## Priority Enhancements

### 1. More obstacle types: rotating cross, pulsing star
### 2. Color power-up: briefly make ball match all colors
### 3. Ghost mode: pass through one ring
### 4. Challenge mode: specific ring sequence to navigate
### 5. Background color reactive to ball color
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Color Switch! Can you beat me?").
