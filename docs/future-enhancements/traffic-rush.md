# Traffic Rush — Future Enhancements

## Priority Enhancements

### 1. Traffic types: car, truck (wide), motorcycle (fast, narrow)
### 2. Power-up: traffic freeze for 3s
### 3. Safe zone islands in center of road
### 4. Rush hour event: triple car density
### 5. Bike mode: player is bicycle, must weave through traffic
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Traffic Rush! Can you beat me?").
