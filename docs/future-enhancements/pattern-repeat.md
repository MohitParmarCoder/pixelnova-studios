# Pattern Repeat — Future Enhancements

## Priority Enhancements

### 1. 5-zone and 6-zone variants
### 2. Visual pattern: sequence shown as drawing on canvas
### 3. Rhythm mode: sequence must be replayed at correct BPM
### 4. Mirror mode: replay sequence in reverse
### 5. Multi-player: pass device, alternate sequences
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Pattern Repeat! Can you beat me?").
