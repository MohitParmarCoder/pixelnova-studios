# Stack Tower — Future Enhancements

## Priority Enhancements

### 1. Block skin packs (stone, ice, wood)
### 2. Earthquake mode: tower wobbles periodically
### 3. Perfect streak counter
### 4. Architect mode: remove lower block from tower without toppling
### 5. Daily tower challenge
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Stack Tower! Can you beat me?").
