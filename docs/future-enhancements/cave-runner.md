# Cave Runner — Future Enhancements

## Priority Enhancements

### 1. Trap tiles: spike pits, cave-ins
### 2. Shop between floors: spend gems on power-ups
### 3. Boss level every 10 floors
### 4. Flashlight mechanic: only adjacent cells visible
### 5. Collectible map pieces revealing safe paths
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Cave Runner! Can you beat me?").
