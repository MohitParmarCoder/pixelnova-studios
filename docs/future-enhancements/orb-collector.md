# Orb Collector — Future Enhancements

## Priority Enhancements

### 1. Magnet power-up: player draws orbs toward it
### 2. Orb types: pulsing (2pts), spinning (3pts), chain (connects to nearby orbs)
### 3. Obstacle orbs that block path
### 4. Time trial mode: collect as many as possible in 30s
### 5. Player trail that scores bonus for orbs touching trail
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Orb Collector! Can you beat me?").
