# Water Flow — Future Enhancements

## Priority Enhancements

### 1. Animated water flowing through connected pipes
### 2. Pressure mechanic: some pipes need 2 connections to open
### 3. One-way pipes (directional valves)
### 4. Timer bonus for quick solves
### 5. Procedural puzzle generator with difficulty rating
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Water Flow! Can you beat me?").
