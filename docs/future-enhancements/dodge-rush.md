# Dodge Rush — Future Enhancements

## Priority Enhancements

### 1. Formation patterns: arrow, circle, cross
### 2. Power-up types: shield, slow-motion, magnet (pull shapes away)
### 3. Boss wave: single giant shape fills half screen
### 4. Screen vibration on near-miss
### 5. Difficulty curve visualization on DEAD screen
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Dodge Rush! Can you beat me?").
