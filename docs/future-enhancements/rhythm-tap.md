# Rhythm Tap — Future Enhancements

## Priority Enhancements

### 1. Original music track with procedurally generated note chart
### 2. Hold notes: press and hold instead of tap
### 3. Multiplier for consecutive perfects
### 4. Calibration tool: adjust tap timing offset
### 5. Beatmap editor for custom note charts
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Rhythm Tap! Can you beat me?").
