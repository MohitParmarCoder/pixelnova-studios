# Lightning Grab — Future Enhancements

## Priority Enhancements

### 1. 4 shades of same color (harder discrimination)
### 2. Pattern mode: flash a shape, recall it (not just color)
### 3. Sound cue mode: flash accompanied by unique tone
### 4. Two-color flash: both must be recalled in order
### 5. Lightning streak: consecutive correct answers grow multiplier
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Lightning Grab! Can you beat me?").
