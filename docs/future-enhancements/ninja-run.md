# Ninja Run — Future Enhancements

## Priority Enhancements

### 1. Rope types: bouncy, sticky (hold longer), breaking (use once)
### 2. Collectible throwing stars award bonus points
### 3. Boss ceiling: spikes drop forcing shorter swing time
### 4. Rope multiplier: chain grabs without touching wall
### 5. Ghost replay of personal best
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Ninja Run! Can you beat me?").
