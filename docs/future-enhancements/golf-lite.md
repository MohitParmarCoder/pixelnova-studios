# Golf Lite — Future Enhancements

## Priority Enhancements

### 1. Spin control: swipe left/right after tap sets English
### 2. Wind direction indicator per hole
### 3. Course map showing holes overview
### 4. Hazards: sand trap, water, rough
### 5. Par challenge: bonus points for under-par rounds
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Golf Lite! Can you beat me?").
