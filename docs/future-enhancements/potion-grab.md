# Potion Grab — Future Enhancements

## Priority Enhancements

### 1. More complex targets: CMYK mixing, gradients
### 2. Fewer adjustments per round (limit slider moves)
### 3. Blind mode: target hidden until 3 seconds remain
### 4. Online challenge: mix same color as opponent faster
### 5. Recipe book: unlock new potion types by achieving perfect mixes
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Potion Grab! Can you beat me?").
