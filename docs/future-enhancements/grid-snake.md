# Grid Snake — Future Enhancements

## Priority Enhancements

### 1. Power tiles: doubler (double head value), halver (halve), wild (eat any)
### 2. Obstacles: walls that appear mid-game
### 3. Challenge mode: reach a target value in fewest moves
### 4. Multiplayer: both snakes share grid, avoid each other
### 5. Visual trail gradient showing snake age
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Grid Snake! Can you beat me?").
