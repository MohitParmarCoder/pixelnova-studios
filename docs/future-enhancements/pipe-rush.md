# Pipe Rush — Future Enhancements

## Priority Enhancements

### 1. Pipe color gradients: colorblind-friendly patterns added
### 2. Power orb: matches any color for one pipe
### 3. Reverse flap: gravity flips direction
### 4. Boss pipe: 8-segment multi-color sequence
### 5. Level system with unlockable visual themes
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Pipe Rush! Can you beat me?").
