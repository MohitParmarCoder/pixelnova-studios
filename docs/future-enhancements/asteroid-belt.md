# Asteroid Belt — Future Enhancements

## Priority Enhancements

### 1. Power-up pickups (shield, triple shot, speed boost)
### 2. Wave system with escalating enemy counts and boss asteroids
### 3. Combo multiplier for consecutive kills without taking damage
### 4. Leaderboard integration via CrazyGames SDK
### 5. Procedural asteroid shapes for visual variety
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Asteroid Belt! Can you beat me?").
