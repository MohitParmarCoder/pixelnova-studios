# Target Blitz — Future Enhancements

## Priority Enhancements

### 1. Moving target zone (zone drifts around ring)
### 2. Power shot: double points for one hit
### 3. Shield ring: must time shot through gap in shield
### 4. Multi-ring mode: two targets simultaneously
### 5. Streak multiplier for consecutive ring-center hits
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Target Blitz! Can you beat me?").
