# Crystal Stack — Future Enhancements

## Priority Enhancements

### 1. Undo last move button (2 uses)
### 2. 5-color variant for higher difficulty
### 3. Tutorial showing optimal move sequence
### 4. Move counter (fewer moves = higher bonus)
### 5. Puzzle pack: 20 pre-designed puzzles
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Crystal Stack! Can you beat me?").
