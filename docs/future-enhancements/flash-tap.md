# Flash Tap — Future Enhancements

## Priority Enhancements

### 1. Grid size scaling (4×4 → 5×5 → 6×6)
### 2. Multi-flash sequence: remember 2–3 positions
### 3. Distractor flashes: adjacent cells briefly light too
### 4. Power-up: slow flash for one round
### 5. Color mode: flash color must be recalled, not just position
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Flash Tap! Can you beat me?").
