# Dino Dash — Future Enhancements

## Priority Enhancements

### 1. Pterodactyl aerial hazard requiring duck
### 2. Meteor shower special event
### 3. Power-ups: invincibility star, magnet (collect coins), speed boost
### 4. Collectible coins spawn on ground
### 5. Day/night cycle with different obstacle sets
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Dino Dash! Can you beat me?").
