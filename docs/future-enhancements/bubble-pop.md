# Bubble Pop — Future Enhancements

## Priority Enhancements

### 1. Special bubbles: bomb (pops 3×3), rainbow (matches any), freeze (stops grid drop)
### 2. Campaign mode with pre-designed puzzles
### 3. Aiming assist line with bounce prediction
### 4. Chain reaction scoring
### 5. Color-blind mode using patterns instead of colors only
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Bubble Pop! Can you beat me?").
