# Spot It — Future Enhancements

## Priority Enhancements

### 1. Category mode: same-colored symbols vs. different symbol
### 2. Multiplier for fast finds
### 3. Night mode: symbols glow on dark background
### 4. Moving symbols: symbols drift slowly
### 5. Level system: grids grow (4×4 → 5×5 → 6×6)
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Spot It! Can you beat me?").
