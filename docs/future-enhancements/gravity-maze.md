# Gravity Maze — Future Enhancements

## Priority Enhancements

### 1. Water level hazard in some cells
### 2. Ice panels: ball slides without slowing
### 3. Teleport gates: enter one, exit the other
### 4. Multiple exit points: choose highest-scoring path
### 5. Editor: design and share custom mazes
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Gravity Maze! Can you beat me?").
