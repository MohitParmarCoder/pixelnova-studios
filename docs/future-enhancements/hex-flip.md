# Hex Flip — Future Enhancements

## Priority Enhancements

### 1. Animated hex rotation on tap
### 2. Ring completion triggers cascade bonus
### 3. Power hex: tap once to cycle entire connected group
### 4. Color-blind mode: patterns instead of solid fills
### 5. Tournament mode: 5 rounds, highest total score wins
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Hex Flip! Can you beat me?").
