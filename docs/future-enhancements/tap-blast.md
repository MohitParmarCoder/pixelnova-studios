# Tap Blast — Future Enhancements

## Priority Enhancements

### 1. Different circle shapes: stars, diamonds, hexagons
### 2. Combo bonus: tap 3+ in quick succession
### 3. Freeze power-up: all circles stop shrinking for 2s
### 4. Chain circles: tap one to see the next
### 5. Invisible mode: circles hidden until near expiry
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Tap Blast! Can you beat me?").
