# Cloud Hop — Future Enhancements

## Priority Enhancements

### 1. Thundercloud hazard (avoid) vs fluffy cloud (ride bonus)
### 2. Wind current zones: speed up or slow kite
### 3. Collectible kite designs unlockable at milestones
### 4. Altitude score: higher altitude = score multiplier
### 5. Night mode: stars collectible, birds harder to see
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Cloud Hop! Can you beat me?").
