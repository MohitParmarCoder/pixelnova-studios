# Neon Snake — Future Enhancements

## Priority Enhancements

### 1. Power-up food: speed boost, ghost (pass through walls briefly), shorten
### 2. Wrap-around walls toggle
### 3. Multiplayer: two snakes on same grid
### 4. Challenge: eat only specific color food
### 5. Neon trail color changes with speed
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Neon Snake! Can you beat me?").
