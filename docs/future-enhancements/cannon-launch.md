# Cannon Launch — Future Enhancements

## Priority Enhancements

### 1. Wind speed and direction modifier
### 2. Ricochet mechanics: ball bounces off walls
### 3. Multi-cannon mode (2 cannons, aim both)
### 4. Target types: static, moving, shielded (2 hits)
### 5. Precision bonus for center-of-target hits
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Cannon Launch! Can you beat me?").
