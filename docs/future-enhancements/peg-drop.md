# Peg Drop — Future Enhancements

## Priority Enhancements

### 1. Special pegs: bouncy, magnetic (deflects toward high slots)
### 2. Wind gusts affecting ball path
### 3. Multi-ball mode: 3 balls in flight simultaneously
### 4. Jackpot slot: one slot worth 50pts but very narrow
### 5. Ghost ball: see exactly where last ball went
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Peg Drop! Can you beat me?").
