# Rooftop Run — Future Enhancements

## Priority Enhancements

### 1. Obstacle types: AC units, water towers, antenna
### 2. Slide mechanic: slide under low obstacles
### 3. Double jump
### 4. Raining weather mode: wet rooftops with slippery landings
### 5. Character parkour animations
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Rooftop Run! Can you beat me?").
