# Sky Hopper — Future Enhancements

## Priority Enhancements

### 1. Jetpack power-up (ignore gravity for 3s)
### 2. Enemy birds that must be avoided
### 3. Platform types: spring (extra bounce), crumbling (one use), moving
### 4. Altitude zones with visual themes (cloud, space, aurora)
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Sky Hopper! Can you beat me?").
