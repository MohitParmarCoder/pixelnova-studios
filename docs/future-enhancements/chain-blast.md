# Chain Blast — Future Enhancements

## Priority Enhancements

### 1. Power bubble types: chain amplifier (doubles chain range), wildcard
### 2. Animated bubble faces (happy/scared)
### 3. Combo counter displayed center-screen for large chains
### 4. Endless mode with increasing bubble density
### 5. Color-blind mode: shape patterns supplement colors
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Chain Blast! Can you beat me?").
