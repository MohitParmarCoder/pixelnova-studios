# Spiral Draw — Future Enhancements

## Priority Enhancements

### 1. Other shapes: star pattern, zigzag, figure-8
### 2. Timed mode: complete spiral in under 10s
### 3. Blur mode: dots fade after showing — memory challenge
### 4. Two-player: alternate dots in same spiral
### 5. Create and share custom dot patterns
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Spiral Draw! Can you beat me?").
