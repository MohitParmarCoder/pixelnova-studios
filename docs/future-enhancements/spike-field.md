# Spike Field — Future Enhancements

## Priority Enhancements

### 1. Platform types: spring (extra bounce), crumbling, magnetic
### 2. Gem collectibles on platforms (bonus score)
### 3. Wind pushes ball left or right
### 4. Boss platform: must land 3 times to pass
### 5. Combo bonus for consecutive platform hits without bouncing off spikes
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Spike Field! Can you beat me?").
