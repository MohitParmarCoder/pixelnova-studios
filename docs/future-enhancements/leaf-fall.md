# Leaf Fall — Future Enhancements

## Priority Enhancements

### 1. Bug types: caterpillar (slow, 3pts), dragonfly (fast, 2pts), butterfly (moves in curves, 4pts)
### 2. Power-up: net (catch all bugs on screen)
### 3. Multiplier chain: consecutive catches increase score rate
### 4. Night mode: bugs glow, harder to track
### 5. Boss round: swarm of 20 bugs appears simultaneously
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Leaf Fall! Can you beat me?").
