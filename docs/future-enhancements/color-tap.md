# Color Tap — Future Enhancements

## Priority Enhancements

### 1. Double Stroop: two words shown, tap the one with matching ink
### 2. Speed escalation visible (timer bar)
### 3. Color names in different languages for international variant
### 4. Correct streak bonus
### 5. Practice mode without timer
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Color Tap! Can you beat me?").
