# Snowball Catch — Future Enhancements

## Priority Enhancements

### 1. Fish types: small (quick reward), large (slow, high value), boot (penalty)
### 2. Fishing skill: catch at exact depth = bonus points
### 3. Ice fishing hole: limited visibility (fish mostly hidden)
### 4. Bait upgrade shop between rounds
### 5. Weather affecting fish depth distribution
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Snowball Catch! Can you beat me?").
