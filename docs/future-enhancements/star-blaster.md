# Star Blaster — Future Enhancements

## Priority Enhancements

### 1. Weapon upgrades: spread, laser, missile
### 2. Shield power-up
### 3. Asteroid field navigation between waves
### 4. Boss health bar
### 5. Multiplayer co-op: two ships
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Star Blaster! Can you beat me?").
