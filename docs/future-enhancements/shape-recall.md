# Shape Recall — Future Enhancements

## Priority Enhancements

### 1. More puzzle count (20+ puzzles)
### 2. Rotation allowed: pieces can be placed at any angle
### 3. Color mode: pieces must match both shape AND color
### 4. Timed speedrun mode
### 5. Procedural puzzle generator
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Shape Recall! Can you beat me?").
