# Tetro Drop — Future Enhancements

## Priority Enhancements

### 1. Ball types: heavy (gravity 2×), bouncy (gravity 0.5×)
### 2. Spinning board mode: board rotates while arm moves
### 3. Multiple balls in flight simultaneously
### 4. Power hole: occasionally appears for 3× score
### 5. Visual trail showing ball path after release
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Tetro Drop! Can you beat me?").
