# Tower Build — Future Enhancements

## Priority Enhancements

### 1. Special block types: wide (bonus), narrow (harder), feather (moves faster)
### 2. Wind gusts affecting block movement
### 3. Foundation crack: tower collapses if perfect not maintained for 5+ blocks
### 4. Ghost of personal best tower shown alongside
### 5. Color theme packs
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Tower Build! Can you beat me?").
