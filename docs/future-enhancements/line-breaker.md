# Line Breaker — Future Enhancements

## Priority Enhancements

### 1. Ball multiplier power-up (2 balls simultaneously)
### 2. Sticky paddle (ball slows to halt, relaunch aim)
### 3. Brick types: exploding, metal (immune to first hit), passthrough glass
### 4. Magnet power-up: attract ball toward paddle
### 5. Level editor
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Line Breaker! Can you beat me?").
