# Sequence Game — Future Enhancements

## Priority Enhancements

### 1. 5-color variant (harder)
### 2. Duplicate colors allowed in code
### 3. Visual number representation of guesses history
### 4. Multiplayer: both players solve same code, fewer guesses wins
### 5. Daily code: everyone solves same code globally
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Sequence Game! Can you beat me?").
