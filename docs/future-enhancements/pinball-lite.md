# Pinball Lite — Future Enhancements

## Priority Enhancements

### 1. Bumper types: exploding (bonus points), magnetic, moving
### 2. Multi-ball mode
### 3. Mission system: hit specific sequence of bumpers
### 4. Ramp shots: reach upper playfield for bonus multiplier
### 5. Nudge mechanic (tilt warning system)
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Pinball Lite! Can you beat me?").
