# Zombie Smash — Future Enhancements

## Priority Enhancements

### 1. Zombie types: speed zombie (fast, 1pt), boss zombie (needs 3 taps, 5pts), armored zombie (needs 2 taps)
### 2. Power-ups: shotgun (blasts column), freeze spray (stops all zombies 3s), barricade (blocks center for 5s)
### 3. Wave announcer with brief preview of upcoming wave
### 4. Survival mode: endless escalating waves
### 5. Co-op: player 1 smashes left half, player 2 right half
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Zombie Smash! Can you beat me?").
