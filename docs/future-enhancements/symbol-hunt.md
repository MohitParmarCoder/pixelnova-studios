# Symbol Hunt — Future Enhancements

## Priority Enhancements

### 1. Decoy symbols (similar-looking but different)
### 2. Rotating grid: grid spins slowly
### 3. Color symbols: find by both shape AND color
### 4. Timer pressure increase after each correct find
### 5. Level designer: create custom symbol grids
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Symbol Hunt! Can you beat me?").
