# Pulse Dodge — Future Enhancements

## Priority Enhancements

### 1. Wave shape variety: square, triangular, sawtooth pulses
### 2. Power-up: pulse freeze (waves stop for 3s)
### 3. Dual orbit: two players orbit simultaneously
### 4. Boss wave: giant single pulse fills 80% of screen
### 5. Harmonic mode: multiple simultaneous wave sources
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Pulse Dodge! Can you beat me?").
