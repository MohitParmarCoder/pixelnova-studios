# Color Memory — Future Enhancements

## Priority Enhancements

### 1. Difficulty: add more keys (12-key mode)
### 2. Two-hand mode: left hand lower keys, right hand upper
### 3. Speed mode: keys animate faster
### 4. Error forgiveness: one wrong key per round allowed
### 5. Sheet music display alongside key highlights
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Color Memory! Can you beat me?").
