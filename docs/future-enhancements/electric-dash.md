# Electric Dash — Future Enhancements

## Priority Enhancements

### 1. Animated electricity flow when circuit complete
### 2. Puzzle generator for infinite unique levels
### 3. Power-up: auto-complete one cell's rotation
### 4. Multi-source circuits requiring all paths connected
### 5. Timed bonus: solve in under 10s for perfect score
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Electric Dash! Can you beat me?").
