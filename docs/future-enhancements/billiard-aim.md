# Billiard Aim — Future Enhancements

## Priority Enhancements

### 1. Cue ball spin control (top/back/side spin)
### 2. Multi-ball mode: pocket all balls in fewest shots
### 3. Trick shot challenges (bank shots, combination)
### 4. Visual trajectory prediction for two-ball angles
### 5. Practice mode with replay of missed shots
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Billiard Aim! Can you beat me?").
