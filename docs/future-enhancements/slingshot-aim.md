# Slingshot Aim — Future Enhancements

## Priority Enhancements

### 1. Physics ricochet off walls
### 2. Moving targets
### 3. Wind indicator
### 4. Elastic stretch visual during aim hold
### 5. Trick shot bonus: hit multiple targets with one shot
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Slingshot Aim! Can you beat me?").
