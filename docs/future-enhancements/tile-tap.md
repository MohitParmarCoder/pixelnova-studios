# Tile Tap — Future Enhancements

## Priority Enhancements

### 1. Hold tiles: must press and hold until glow fades
### 2. Bomb tiles: must NOT tap
### 3. Lane indicator light: pre-flash the next active lane
### 4. Multiplier for consecutive perfect hits
### 5. Custom BPM setting for speed calibration
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Tile Tap! Can you beat me?").
