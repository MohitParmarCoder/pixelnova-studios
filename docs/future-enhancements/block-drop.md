# Block Drop — Future Enhancements

## Priority Enhancements

### 1. Next-piece preview (1–3 pieces ahead)
### 2. Hold piece mechanic
### 3. T-spin and wall-kick rotation system
### 4. Ghost piece showing drop position
### 5. Marathon mode with increasing speeds
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Block Drop! Can you beat me?").
