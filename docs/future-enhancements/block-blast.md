# Block Blast — Future Enhancements

## Priority Enhancements

### 1. Special block types: bomb (clears 3×3), wildcard, frozen
### 2. Combo system: chain clears score multiplier
### 3. Color-coded difficulty levels (easy/medium/hard board density)
### 4. Time attack mode: clear board in 30 seconds
### 5. Power-up strip (earn by combo): clear row, clear column, add time
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Block Blast! Can you beat me?").
