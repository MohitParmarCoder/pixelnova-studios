# Color Flood — Future Enhancements

## Priority Enhancements

### 1. Hint system: highlight which tile to move next
### 2. Undo button (3 uses per game)
### 3. Larger grid sizes (5×5, 6×6) as difficulty levels
### 4. Timed mode with leaderboard
### 5. Custom puzzle creator and share code
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Color Flood! Can you beat me?").
