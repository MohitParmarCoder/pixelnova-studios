# Gem Collector — Future Enhancements

## Priority Enhancements

### 1. Magnet power-up: pulls all gems toward player for 3s
### 2. Gem fever: chain 5+ collectibles = 2× score for 5s
### 3. Different gem shapes (diamond, emerald, ruby) with lore
### 4. Moving obstacles player must navigate around
### 5. Daily challenge gem layout
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Gem Collector! Can you beat me?").
