# Chain Tap — Future Enhancements

## Priority Enhancements

### 1. Longer chains unlock power moves (clear all of one color)
### 2. Timed chain mode: chain must complete within 2 seconds
### 3. Color merge: tapping at junction of two colors creates hybrid
### 4. Visual chain lightning between tapped bubbles
### 5. Leaderboard for longest chain
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Chain Tap! Can you beat me?").
