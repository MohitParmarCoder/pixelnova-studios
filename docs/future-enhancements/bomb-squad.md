# Bomb Squad — Future Enhancements

## Priority Enhancements

### 1. Simultaneous multi-bomb screen (defuse whichever you reach first)
### 2. Bomb types: slow-countdown, fast-countdown, decoy (costs life to defuse)
### 3. Double-tap prevention is already in — extend with haptic feedback on correct defuse
### 4. Survival mode: bombs accelerate in spawn rate
### 5. Co-op mode stub: two players defuse separate halves of screen
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Bomb Squad! Can you beat me?").
