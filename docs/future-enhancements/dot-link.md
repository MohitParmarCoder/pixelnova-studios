# Dot Link — Future Enhancements

## Priority Enhancements

### 1. Editor mode: create and share custom puzzles
### 2. Hint system (show one correct path segment)
### 3. Multiplayer race: who solves same puzzle fastest
### 4. Larger grids (8×8, 10×10)
### 5. Diagonal connection variant
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Dot Link! Can you beat me?").
