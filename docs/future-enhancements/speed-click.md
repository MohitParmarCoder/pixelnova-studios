# Speed Click — Future Enhancements

## Priority Enhancements

### 1. Multi-dot mode: 3 dots on screen simultaneously
### 2. Shrink speed increase per level
### 3. Combo: tap 10 in a row within 1s for bonus
### 4. Accessibility size setting
### 5. Ghost mode: tap dot whose shadow appears before it
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Speed Click! Can you beat me?").
