# Pool Shots — Future Enhancements

## Priority Enhancements

### 1. Cue ball spin affecting final position
### 2. Bank shots off walls
### 3. Multi-ball challenge: pocket all balls
### 4. Moving bumpers for dynamic play
### 5. Tournament mode: lowest total shots across 9 holes
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Pool Shots! Can you beat me?").
