# Missile Evade — Future Enhancements

## Priority Enhancements

### 1. Power interceptors: homing, multi-shot, area blast
### 2. Repair kit power-up (restore 1 city HP)
### 3. Missile types: fast, cluster (splits into 3), stealth (faded appearance)
### 4. Bunker protection: shield cities for 5s
### 5. Ally ship that auto-intercepts every 10 seconds
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Missile Evade! Can you beat me?").
