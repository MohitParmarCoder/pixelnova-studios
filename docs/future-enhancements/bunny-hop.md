# Bunny Hop — Future Enhancements

## Priority Enhancements

### 1. Collectible carrots that grant speed boost
### 2. Platform types: ice (slippery), spring (extra bounce), moving
### 3. Day/night cycle affecting visibility
### 4. Character skins unlocked at score milestones
### 5. Daily challenge with seed-based platform layout
...
### Social Sharing
Add "Share Score" button on DEAD screen that generates a simple text share ("I scored X in Bunny Hop! Can you beat me?").
