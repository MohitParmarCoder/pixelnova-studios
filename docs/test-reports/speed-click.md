...
## Syntax Check
```bash
node --check speed-click/js/game.js
...
| Best score persisted to `speedclick_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — dot shrink rate uses dt; clamping prevents instant shrink.
