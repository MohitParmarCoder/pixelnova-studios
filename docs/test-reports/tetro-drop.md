...
## Syntax Check
```bash
node --check tetro-drop/js/game.js
...
| Best score persisted to `tetrodrop_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — ball physics uses dt; clamping prevents tunneling through holes.
