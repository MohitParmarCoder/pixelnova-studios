...
## Syntax Check
```bash
node --check ninja-run/js/game.js
...
| Best score persisted to `ninjarun_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — swing physics uses dt; clamping prevents rope from overshooting anchors.
