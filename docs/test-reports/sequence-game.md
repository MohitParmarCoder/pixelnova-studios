...
## Syntax Check
```bash
node --check sequence-game/js/game.js
...
| Best score persisted to `sequencegame_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — puzzle animations use dt; discrete logic unaffected.
