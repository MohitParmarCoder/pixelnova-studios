...
## Syntax Check
```bash
node --check bubble-pop/js/game.js
...
| Best score persisted to `bubblepop_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents bubble velocity from exceeding grid bounds.
