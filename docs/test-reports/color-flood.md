...
## Syntax Check
```bash
node --check color-flood/js/game.js
...
| Best score persisted to `colorflood_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — tile animations use dt; clamping prevents tiles from teleporting.
