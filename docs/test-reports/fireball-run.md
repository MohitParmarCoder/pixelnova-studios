...
## Syntax Check
```bash
node --check fireball-run/js/game.js
...
| Best score persisted to `fireballrun_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents arrows from tunneling through fast-moving enemies.
