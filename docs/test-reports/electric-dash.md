...
## Syntax Check
```bash
node --check electric-dash/js/game.js
...
| Best score persisted to `electricdash_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — timer uses dt; circuit connectivity check is discrete.
