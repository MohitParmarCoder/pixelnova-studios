...
## Syntax Check
```bash
node --check missile-evade/js/game.js
...
| Best score persisted to `missileevade_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied to missile speeds. PR #22 fix prevents uninterceptable missiles.
