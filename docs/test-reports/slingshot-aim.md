...
## Syntax Check
```bash
node --check slingshot-aim/js/game.js
...
| Best score persisted to `slingshotaim_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — ball physics uses dt; clamping prevents tunneling through targets.
