...
## Syntax Check
```bash
node --check golf-lite/js/game.js
...
| Best score persisted to `golflite_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — ball physics uses dt; clamping prevents ball from tunneling through hole.
