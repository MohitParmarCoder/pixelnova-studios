...
## Syntax Check
```bash
node --check pool-shots/js/game.js
...
| Best score persisted to `poolshots_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — disc physics uses dt; clamping prevents tunneling through scoring zones.
