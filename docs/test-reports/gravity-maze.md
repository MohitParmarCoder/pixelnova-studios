...
## Syntax Check
```bash
node --check gravity-maze/js/game.js
...
| Best score persisted to `gravitymaze_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents ball from tunneling through maze walls.
