...
## Syntax Check
```bash
node --check neon-snake/js/game.js
...
| Best score persisted to `neonsnake_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — movement tick-based so dt mainly affects animation.
