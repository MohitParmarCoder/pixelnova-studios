...
## Syntax Check
```bash
node --check egg-drop/js/game.js
...
| Best score persisted to `eggdrop_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents falling items from skipping the catch zone.
