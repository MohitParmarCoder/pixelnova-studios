...
## Syntax Check
```bash
node --check flash-tap/js/game.js
...
| Best score persisted to `flashtap_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — flash timer and tap window use dt; clamping keeps them sane after suspension.
