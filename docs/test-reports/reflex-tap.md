...
## Syntax Check
```bash
node --check reflex-tap/js/game.js
...
| Best score persisted to `reflextap_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — ring rotation speed cap applied. PR #22.
