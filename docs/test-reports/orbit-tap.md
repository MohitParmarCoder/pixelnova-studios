...
## Syntax Check
```bash
node --check orbit-tap/js/game.js
...
| Best score persisted to `orbittap_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — orbital speed cap applied. PR #22 fix prevents orbit too fast to tap.
