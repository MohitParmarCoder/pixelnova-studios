...
## Syntax Check
```bash
node --check shape-recall/js/game.js
...
| Best score persisted to `shaperecall_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — piece movement animations use dt; placement logic is discrete.
