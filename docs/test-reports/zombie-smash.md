...
## Syntax Check
```bash
node --check zombie-smash/js/game.js
...
| Best score persisted to `zombiesmash_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — max 1 life lost per frame from simultaneous zombies. PR #22 fix verified.
