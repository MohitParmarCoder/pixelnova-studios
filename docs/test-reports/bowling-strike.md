...
## Syntax Check
```bash
node --check bowling-strike/js/game.js
...
| Best score persisted to `bowlingstrike_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents ball physics tunneling through pins on slow frames.
