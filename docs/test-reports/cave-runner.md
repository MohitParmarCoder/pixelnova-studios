...
## Syntax Check
```bash
node --check cave-runner/js/game.js
...
| Best score persisted to `caverunner_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — grid navigation is discrete so dt mainly affects particle animations.
