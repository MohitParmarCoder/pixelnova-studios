...
## Syntax Check
```bash
node --check pulse-dodge/js/game.js
...
| Best score persisted to `pulsedodge_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — wave expansion uses dt; speed cap applied. PR #22.
