...
## Syntax Check
```bash
node --check crystal-stack/js/game.js
...
| Best score persisted to `crystalstack_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — ball drop animations use dt; clamping prevents overshooting tube targets.
