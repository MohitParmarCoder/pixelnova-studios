...
## Syntax Check
```bash
node --check endless-runner/js/game.js
...
| Best score persisted to `endlessrunner_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied: MIN(speed, MAX_SPEED). PR #22 fix prevents impossible speed after tab-switch.
