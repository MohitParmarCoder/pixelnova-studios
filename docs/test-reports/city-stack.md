...
## Syntax Check
```bash
node --check city-stack/js/game.js
...
| Best score persisted to `citystack_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents moving block from skipping past the stack boundary.
