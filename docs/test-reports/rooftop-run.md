...
## Syntax Check
```bash
node --check rooftop-run/js/game.js
...
| Best score persisted to `rooftoprun_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — platform scroll speed cap applied. PR #22.
