...
## Syntax Check
```bash
node --check line-breaker/js/game.js
...
| Best score persisted to `linebreaker_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied to ball speed. PR #22 fix prevents ball from tunneling at high speed.
