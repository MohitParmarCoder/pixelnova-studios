...
## Syntax Check
```bash
node --check pattern-repeat/js/game.js
...
| Best score persisted to `patternrepeat_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — flash timers use dt; clamping prevents sequence from playing too fast.
