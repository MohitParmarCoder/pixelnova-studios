...
## Syntax Check
```bash
node --check lava-surf/js/game.js
...
| Best score persisted to `lavasurf_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — stone slide physics uses dt; clamping prevents overshooting target zones.
