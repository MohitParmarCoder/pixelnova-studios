...
## Syntax Check
```bash
node --check traffic-rush/js/game.js
...
| Best score persisted to `trafficrush_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — cars still dodgeable at score 20+ verified in PR #22.
