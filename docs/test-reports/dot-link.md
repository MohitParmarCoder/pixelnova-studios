...
## Syntax Check
```bash
node --check dot-link/js/game.js
...
| Best score persisted to `dotlink_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — path animation uses dt; discrete grid logic unaffected.
