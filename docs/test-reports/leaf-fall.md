...
## Syntax Check
```bash
node --check leaf-fall/js/game.js
...
| Best score persisted to `leaffall_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied to bug horizontal speed. PR #22 fix prevents impossible tracking speed.
