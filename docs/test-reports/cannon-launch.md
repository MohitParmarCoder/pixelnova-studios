...
## Syntax Check
```bash
node --check cannon-launch/js/game.js
...
| Best score persisted to `cannonlaunch_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents ball from tunneling through targets at high simulation speed.
