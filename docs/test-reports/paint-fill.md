...
## Syntax Check
```bash
node --check paint-fill/js/game.js
...
| Best score persisted to `paintfill_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — fill animation uses dt; clamping prevents instant fill on slow frames.
