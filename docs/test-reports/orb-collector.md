...
## Syntax Check
```bash
node --check orb-collector/js/game.js
...
| Best score persisted to `orbcollector_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied to orb drift speed. PR #22 fix.
