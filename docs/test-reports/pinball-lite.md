...
## Syntax Check
```bash
node --check pinball-lite/js/game.js
...
| Best score persisted to `pinballlite_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — ball speed cap applied. PR #22 prevents ball escaping playfield.
