...
## Syntax Check
```bash
node --check chain-blast/js/game.js
...
| Best score persisted to `chainblast_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents chain animation from completing in a single frame.
