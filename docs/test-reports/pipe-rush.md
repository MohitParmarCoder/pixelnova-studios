...
## Syntax Check
```bash
node --check pipe-rush/js/game.js
...
| Best score persisted to `piperush_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents orb from passing through pipes in single frame.
