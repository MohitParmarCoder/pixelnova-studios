...
## Syntax Check
```bash
node --check dodge-rush/js/game.js
...
| Best score persisted to `dodgerush_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents enemies from overshooting player in single frame.
