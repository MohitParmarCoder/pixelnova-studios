...
## Syntax Check
```bash
node --check pixel-trace/js/game.js
...
| Best score persisted to `pixeltrace_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — trace speed uses dt; clamping keeps drawing animations smooth.
