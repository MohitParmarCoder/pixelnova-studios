...
## Syntax Check
```bash
node --check lightning-grab/js/game.js
...
| Best score persisted to `lightninggrab_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — flash/choose timers use dt; clamping prevents phase skipping.
