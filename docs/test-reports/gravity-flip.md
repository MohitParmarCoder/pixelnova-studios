...
## Syntax Check
```bash
node --check gravity-flip/js/game.js
...
| Best score persisted to `gravityflip_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents character from passing through corridor walls at high speed.
