...
## Syntax Check
```bash
node --check color-switch/js/game.js
...
| Best score persisted to `colorswitch_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents ball from tunneling through ring arcs.
