...
## Syntax Check
```bash
node --check match-gems/js/game.js
...
| Best score persisted to `matchgems_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — swap animation uses dt; clamping prevents animations from completing instantly.
