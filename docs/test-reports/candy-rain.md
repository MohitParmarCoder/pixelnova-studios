...
## Syntax Check
```bash
node --check candy-rain/js/game.js
...
| Best score persisted to `candyrain_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents timer overflow when tab loses focus.
