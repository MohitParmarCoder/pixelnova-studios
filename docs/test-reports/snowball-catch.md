...
## Syntax Check
```bash
node --check snowball-catch/js/game.js
...
| Best score persisted to `snowballcatch_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — hook speed cap applied. PR #22.
