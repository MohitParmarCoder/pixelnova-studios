...
## Syntax Check
```bash
node --check sky-hopper/js/game.js
...
| Best score persisted to `skyhopper_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents character from tunneling through platforms at high vertical speed.
