...
## Syntax Check
```bash
node --check balance-beam/js/game.js
...
| Best score persisted to `balancebeam_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents runaway angular velocity accumulation on tab-switch resume.
