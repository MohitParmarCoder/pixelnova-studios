...
## Syntax Check
```bash
node --check target-blitz/js/game.js
...
| Best score persisted to `targetblitz_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — sweep bar speed cap applied. PR #22.
