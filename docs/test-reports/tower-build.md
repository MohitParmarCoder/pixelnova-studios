...
## Syntax Check
```bash
node --check tower-build/js/game.js
...
| Best score persisted to `towerbuild_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — block speed cap (MAX_SPEED = 400). PR #22.
