...
## Syntax Check
```bash
node --check dino-dash/js/game.js
...
| Best score persisted to `dinodash_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents character from tunneling through ground or obstacles.
