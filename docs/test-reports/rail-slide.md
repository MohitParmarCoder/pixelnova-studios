...
## Syntax Check
```bash
node --check rail-slide/js/game.js
...
| Best score persisted to `railslide_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied. PR #22 fix. Dead screen text shadow bleed fix verified.
