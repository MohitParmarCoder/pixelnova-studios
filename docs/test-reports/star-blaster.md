...
## Syntax Check
```bash
node --check star-blaster/js/game.js
...
| Best score persisted to `starblaster_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — speed cap applied to enemy descent rate. PR #22.
