...
## Syntax Check
```bash
node --check tap-blast/js/game.js
...
| Best score persisted to `tapblast_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — no overlapping circles at spawn verified fix in PR #22.
