...
## Syntax Check
```bash
node --check color-burst/js/game.js
...
| Best score persisted to `colorburst_best` | PASS |
...
## dt Clamp Fix (PR #22)
dt clamped to 0.05s — prevents ring expansion from overshooting target radius.
