# Pipe Rush — Usability Report

## Overview
- **Game:** Pipe Rush
- **Genre:** Flappy Variant
- **Target audience:** Casual, reflex
- **Typical session length:** 60s–3min
- **Learning curve:** Low
...
## UX Strengths
- Single-tap flap is immediately learnable from Flappy Bird history\n- Color matching adds layer discovered naturally
