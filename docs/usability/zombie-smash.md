# Zombie Smash — Usability Report

## Overview
- **Game:** Zombie Smash
- **Genre:** Tap Defense
- **Target audience:** Casual, action
...
## UX Strengths
- Zombie art is expressive and readable\n- Center line makes threat proximity clear\n- Smash animation provides satisfying feedback
