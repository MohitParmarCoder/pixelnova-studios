# Cave Runner — Usability Report

## Overview
- **Game:** Cave Runner
- **Genre:** Grid Exploration
- **Target audience:** Casual, puzzle fans
...
## UX Strengths
- Cell icons clearly distinguish rock/gem/gold/bomb\n- Grid navigation is methodical and satisfying
