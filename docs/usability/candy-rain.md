# Candy Rain — Usability Report

## Overview
- **Game:** Candy Rain
- **Genre:** Number Matching
- **Target audience:** Casual, numeracy practice
...
## UX Strengths
- Target number prominently displayed — no ambiguity about objective\n- Bouncing numbers add visual variety without confusion
