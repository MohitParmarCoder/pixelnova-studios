# Balance Beam — Usability Report

## Overview
- **Game:** Balance Beam
- **Genre:** Physics Puzzle
- **Target audience:** Casual mobile, all ages
- **Typical session length:** 90s–3min
- **Learning curve:** Low
...
## UX Strengths
- Physics feedback (beam tilting) is intuitive — visual angle clearly communicates danger\n- Weight numbers on items help plan placement before committing
