# Cloud Hop — Usability Report

## Overview
- **Game:** Cloud Hop
- **Genre:** Endless Runner
- **Target audience:** Casual, kids
...
## UX Strengths
- Hold-to-rise mechanic is immediately intuitive\n- Birds and stars visually distinct in color and shape
