# Sequence Game — Usability Report

## Overview
- **Game:** Sequence Game
- **Genre:** Mastermind Puzzle
- **Target audience:** Puzzle players, older teens+
- **Typical session length:** 3–10min
...
## UX Strengths
- Black/white peg feedback is Mastermind convention\n- Color palette distinct per code slot\n- History of guesses displayed in scrollable list
