# Bowling Strike — Usability Report

## Overview
- **Game:** Bowling Strike
- **Genre:** Sports Physics
- **Target audience:** Casual, sports fans
...
## UX Strengths
- Swipe gesture for bowling matches physical intuition\n- Pin reset animation clearly communicates frame reset
