# Cannon Launch — Usability Report

## Overview
- **Game:** Cannon Launch
- **Genre:** Physics Shooting
- **Target audience:** Casual, strategy
- **Typical session length:** 2–4min
...
## UX Strengths
- Two-tap aim system requires learning but is predictable\n- Trajectory arc shown before shot confirms aim
