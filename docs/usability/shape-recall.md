# Shape Recall — Usability Report

## Overview
- **Game:** Shape Recall
- **Genre:** Tangram Puzzle
- **Target audience:** Casual, puzzle
- **Typical session length:** 3–8min
...
## UX Strengths
- Selected piece highlighted clearly\n- Target silhouette shows correct orientation\n- Incorrect placement indicated by red flash
