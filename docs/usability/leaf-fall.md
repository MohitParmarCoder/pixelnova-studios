...
## UX Strengths
- Bugs horizontally distinct — movement reads well against static background\n- Gold bugs visually emphasized — higher point value is immediately obvious
