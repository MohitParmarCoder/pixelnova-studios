# Rooftop Run — Usability Report

## Overview
- **Game:** Rooftop Run
- **Genre:** Platformer
- **Target audience:** Casual, timing
...
## UX Strengths
- Shrinking window indicators add urgency\n- Platform positions are readable one ahead — fair reaction time
